...
- Replace inline `style` attributes and inline event handlers in public HTML with classes/listeners, then enable a strict Helmet Content Security Policy for Google Fonts, Font Awesome, and Vercel Analytics.
